...
Jerry's civic content is that of an engaged resident learning how local
government works, in public, honestly — never as a government spokesperson,
journalist claiming a complete record, attorney, police expert, or
representative of all Covington residents.
...
- Recheck the draft against `docs/GUARDRAILS.md` before it ships, same as
